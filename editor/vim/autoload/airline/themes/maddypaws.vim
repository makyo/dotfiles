" Maddypaws' Airline - A Material Color Scheme
" extended from minimalist theme
"
...
"     let g:airline_maddypaws_showmod = 1
let s:want_showmod = get(g:, 'airline_maddypaws_showmod', 0)
...
function! airline#themes#{s:theme}#refresh()
    if &background == "dark"
        ...
        let N3 = [ '#EEEEEE', '#222222', 254, 'NONE' ]

        " Inactive
        let IA = [ '#666666', N3[1], 242, 235 ]
